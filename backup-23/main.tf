...
############################################
# API GATEWAY STAGE
# NOTE: Actual stage with logging is in observability.tf
# This is just a placeholder/comment for reference
############################################

# Stage resource moved to observability.tf to manage logging properly
